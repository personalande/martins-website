  ...
  return (
    <div>
      ...
      <div style={{ background: 'var(--martins-white)', border: '1.5px solid var(--martins-border)', borderRadius: 'var(--radius-lg)', padding: 'var(--space-3xl) var(--space-xl)', textAlign: 'center' }}>
         <h2 style={{ fontSize: '1.2rem', color: 'var(--martins-blue-950)', marginBottom: 'var(--space-sm)' }}>Configurações Gerais</h2>
         <p style={{ color: 'var(--martins-steel)' }}>Gerencie números de WhatsApp, dados das lojas e textos legais (Termos e Políticas).</p>
      </div>
    </div>
  )
}
