...
const IconMap: Record<string, React.ReactNode> = {
  ...
  hammer: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M15 4h5v5h-5z"/><path d="M17.5 9v11a1 1 0 0 1-2 0V9"/><path d="M15 4l-4 4"/></svg>,
  ...
  'paint-brush': <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18.36 4.64a3 3 0 0 0-4.24 0L12 6.76l4.24 4.24 2.12-2.12a3 3 0 0 0 0-4.24z"/><path d="M14 9l-9.17 9.17a2.12 2.12 0 0 0-.59 1.5v1.2A1.13 1.13 0 0 0 5.38 22h1.21a2.12 2.12 0 0 0 1.5-.59L17.26 12"/></svg>,
  ...
  layers: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 12 12 17 22 12"/><polyline points="2 17 12 22 22 17"/></svg>,
  ...
  return (
    <Link href={`/catalogo/${slug}`} className={styles.card}>
      ...
      {productCount !== undefined && (
        <span className={styles.count}>{productCount} produtos</span>
      )}
    </Link>
  );
}
